---
id: BE-WEEK-05
title: Backend Week 5 — Operational Integration, Recovery and Full-Flow QA
...
# Backend Week 5 — Operational Integration, Recovery and Full-Flow QA
...
### BE-W5D1 — Admin operational APIs

```task-metadata
id: BE-W5D1
title: Admin operational APIs
type: build-task
...
last_reviewed: 2026-07-17
authority: Approved legacy build-plan and weekly-pack meaning in the approved Phase 3 task-card format
related: AF-03, AF-05, AF-06, AF-08, AF-13, AF-22, BE-W4D5, CONTRACT-001, DATA-001, PROVIDER-001
...
When accepted, the Backend team will have delivered this demonstrable outcome: Implement admin users, tasks, finance, reports, media, ratings, config APIs.

### Why it matters

This work matters because the approved plan names this dependency or handoff: Unblocks admin complete modules. Without that input or downstream need, the outcome cannot be accepted confidently. The result must also preserve this output rule: feat(admin): implement operational APIs
...
| --- | --- | --- |
| BE-W4D5 | Provides support/emergency required before this task can be accepted. | BE-W4D5 is accepted, or its explicitly required contract/stub and evidence are available. |
| Legacy dependency | Unblocks admin complete modules. | The named contract, state, environment or prior outcome is demonstrably available. |
...
- Agent Markdown for AF-03, AF-05, AF-06, AF-08, AF-13, AF-22 or the complete Flow Library when the task spans the platform.
- Approved contract and data-model sections named by the scope.
- Accepted designs, copy, permission rules and test data for Admin operational APIs.
...
- [ ] The output rule is satisfied: feat(admin): implement operational APIs
...
- [ ] Verify the legacy output rule: feat(admin): implement operational APIs
...
- BE-W5D2 can consume this task's accepted output or handoff.
...
### BE-W5D2 — Referral and notification APIs

```task-metadata
id: BE-W5D2
title: Referral and notification APIs
type: build-task
audience: Junior backend developers, QA, AI agents
owner: Backend Lead
reviewers: Technical Lead, Mobile Lead, Admin Lead, QA
...
last_reviewed: 2026-07-17
authority: Approved legacy build-plan and weekly-pack meaning in the approved Phase 3 task-card format
related: MF-17, MF-20, AF-15, AF-21, BE-W5D1, CONTRACT-REFERRAL-001, CONTRACT-001, DATA-001, PROVIDER-001
delivery_stage: mobile-backend-construction
stage_order: 2
legacy_slot: W5D2
```
...
When accepted, the Backend team will have delivered this demonstrable outcome: Implement referral reward tracking, notifications list/read, announcements.

### Why it matters

This work matters because the approved plan names this dependency or handoff: Unblocks mobile referral/admin announcements. Without that input or downstream need, the outcome cannot be accepted confidently. The result must also preserve this output rule: feat(growth): implement referral and notifications
...
| AF-15 | Defines approved behavior, states or handoffs that this task must preserve. |
| AF-21 | Defines approved behavior, states or handoffs that this task must preserve. |
| CONTRACT-REFERRAL-001 | Defines exact referral reads, Admin decisions, attribution input, idempotency and server-owned reward settlement. |
| CONTRACT-001 | Supplies the current API/socket baseline; missing exact contracts remain explicit gaps. |
| DATA-001 | Supplies model, state, audit and persistence expectations where the scope stores data. |
| PROVIDER-001 | Supplies adapter, validation, fallback and cost-control rules for named providers. |
...
| Dependency | Why needed | Readiness evidence |
| --- | --- | --- |
| BE-W5D1 | Provides admin operational apis required before this task can be accepted. | BE-W5D1 is accepted, or its explicitly required contract/stub and evidence are available. |
| Legacy dependency | Unblocks mobile referral/admin announcements. | The named contract, state, environment or prior outcome is demonstrably available. |
...
- Agent Markdown for MF-17, MF-20, AF-15, AF-21 or the complete Flow Library when the task spans the platform.
- Approved referral and notification contract sections plus the required data models.
- Accepted designs, copy, permission rules and test data for Referral and notification APIs.
- The environment, credentials, fixtures and prior-task evidence listed under dependencies.
...
Google Maps Platform, Firebase Cloud Messaging. Treat availability, credentials, sandbox behavior, timeouts and cost controls as readiness evidence; do not infer them from the schedule.
...
- [ ] Contract-compatible fixtures cover each later integration gate without pretending that real integration is complete.
- [ ] Referenced flow behavior, permissions, endings and recovery remain unchanged.
- [ ] The output rule is satisfied: feat(growth): implement referral and notifications
- [ ] Failure, retry and stale-state behavior cannot display false success.
- [ ] Required tests and evidence pass in the target environment.
...
- [ ] Exercise one dependency failure and confirm recovery does not show false success.
- [ ] Verify the legacy output rule: feat(growth): implement referral and notifications
- [ ] Verify logs, metrics and persisted state contain no secret or unnecessary sensitive data.
...
- BE-W5D3 can consume this task's accepted output or handoff.
...
last_reviewed: 2026-07-17
authority: Approved legacy build-plan and weekly-pack meaning in the approved Phase 3 task-card format
related: FLOW-LIB-001, BE-W5D2, CONTRACT-001, DATA-001, PROVIDER-001
delivery_stage: mobile-backend-construction
stage_order: 2
legacy_slot: W5D3
```
...
When accepted, the Backend team will have delivered this demonstrable outcome: Validate Paystack, Moniepoint, Smile ID, Google Maps, Termii, FCM, Sentry, object storage in staging.

### Why it matters

This work matters because the approved plan names this dependency or handoff: Unblocks provider QA. Without that input or downstream need, the outcome cannot be accepted confidently. The result must also preserve this output rule: fix(providers): harden staging integrations
...
| Dependency | Why needed | Readiness evidence |
| --- | --- | --- |
| BE-W5D2 | Provides referral and notification apis required before this task can be accepted. | BE-W5D2 is accepted, or its explicitly required contract/stub and evidence are available. |
| Legacy dependency | Unblocks provider QA. | The named contract, state, environment or prior outcome is demonstrably available. |
...
- Approved contract and data-model sections named by the scope.
- Accepted designs, copy, permission rules and test data for Provider hardening.
- The environment, credentials, fixtures and prior-task evidence listed under dependencies.
...
Smile ID, Google Maps Platform, Firebase Cloud Messaging, Approved object storage, Sentry and approved monitoring services where applicable. Treat availability, credentials, sandbox behavior, timeouts and cost controls as readiness evidence; do not infer them from the schedule.
...
- [ ] Contract-compatible fixtures cover each later integration gate without pretending that real integration is complete.
- [ ] Referenced flow behavior, permissions, endings and recovery remain unchanged.
- [ ] The output rule is satisfied: fix(providers): harden staging integrations
- [ ] Failure, retry and stale-state behavior cannot display false success.
- [ ] Required tests and evidence pass in the target environment.
...
- [ ] Exercise one dependency failure and confirm recovery does not show false success.
- [ ] Verify the legacy output rule: fix(providers): harden staging integrations
- [ ] Verify logs, metrics and persisted state contain no secret or unnecessary sensitive data.
...
- BE-W5D4 can consume this task's accepted output or handoff.
...
last_reviewed: 2026-07-17
authority: Approved legacy build-plan and weekly-pack meaning in the approved Phase 3 task-card format
related: AF-19, AF-20, BE-W5D3, CONTRACT-001, DATA-001, PROVIDER-001
delivery_stage: mobile-backend-construction
stage_order: 2
legacy_slot: W5D4
```
...
When accepted, the Backend team will have delivered this demonstrable outcome: Implement use-case health, queue audit, provider request logs, metrics, backup status.

### Why it matters

This work matters because the approved plan names this dependency or handoff: Unblocks admin monitoring. Without that input or downstream need, the outcome cannot be accepted confidently. The result must also preserve this output rule: feat(ops): implement use case health and monitoring
...
| Dependency | Why needed | Readiness evidence |
| --- | --- | --- |
| BE-W5D3 | Provides provider hardening required before this task can be accepted. | BE-W5D3 is accepted, or its explicitly required contract/stub and evidence are available. |
| Legacy dependency | Unblocks admin monitoring. | The named contract, state, environment or prior outcome is demonstrably available. |
...
- Approved contract and data-model sections named by the scope.
- Accepted designs, copy, permission rules and test data for Operations/monitoring.
- The environment, credentials, fixtures and prior-task evidence listed under dependencies.
...
- [ ] Contract-compatible fixtures cover each later integration gate without pretending that real integration is complete.
- [ ] Referenced flow behavior, permissions, endings and recovery remain unchanged.
- [ ] The output rule is satisfied: feat(ops): implement use case health and monitoring
- [ ] Failure, retry and stale-state behavior cannot display false success.
- [ ] Required tests and evidence pass in the target environment.
...
- [ ] Exercise one dependency failure and confirm recovery does not show false success.
- [ ] Verify the legacy output rule: feat(ops): implement use case health and monitoring
- [ ] Verify logs, metrics and persisted state contain no secret or unnecessary sensitive data.
...
- BE-W5D5 can consume this task's accepted output or handoff.
...
### BE-W5D5 — Integrated defect pass

```task-metadata
id: BE-W5D5
title: Integrated defect pass
type: build-task
audience: Junior backend developers, QA, AI agents
owner: Backend Lead
reviewers: Technical Lead, Mobile Lead, Admin Lead, QA
...
last_reviewed: 2026-07-17
authority: Approved legacy build-plan and weekly-pack meaning in the approved Phase 3 task-card format
related: FLOW-LIB-001, BE-W5D4, CONTRACT-001, DATA-001
delivery_stage: mobile-backend-construction
stage_order: 2
legacy_slot: W5D5
```
...
When accepted, the Backend team will have delivered this demonstrable outcome: Fix defects from mobile/admin full-flow QA, contract mismatches, state recovery issues.

### Why it matters

This work matters because the approved plan names this dependency or handoff: All teams integration. Without that input or downstream need, the outcome cannot be accepted confidently. The result must also preserve this output rule: fix(integration): resolve full flow defects
...
| Dependency | Why needed | Readiness evidence |
| --- | --- | --- |
| BE-W5D4 | Provides operations/monitoring required before this task can be accepted. | BE-W5D4 is accepted, or its explicitly required contract/stub and evidence are available. |
| Legacy dependency | All teams integration. | The named contract, state, environment or prior outcome is demonstrably available. |
...
- Agent Markdown for FLOW-LIB-001 or the complete Flow Library when the task spans the platform.
- Approved contract and data-model sections named by the scope.
- Accepted designs, copy, permission rules and test data for Integrated defect pass.
- The environment, credentials, fixtures and prior-task evidence listed under dependencies.
...
- [ ] Contract-compatible fixtures cover each later integration gate without pretending that real integration is complete.
- [ ] Referenced flow behavior, permissions, endings and recovery remain unchanged.
- [ ] The output rule is satisfied: fix(integration): resolve full flow defects
- [ ] Failure, retry and stale-state behavior cannot display false success.
- [ ] Required tests and evidence pass in the target environment.
...
- [ ] Exercise one dependency failure and confirm recovery does not show false success.
- [ ] Verify the legacy output rule: fix(integration): resolve full flow defects
- [ ] Verify logs, metrics and persisted state contain no secret or unnecessary sensitive data.
...
- BE-W6D1 can consume this task's accepted output or handoff.
