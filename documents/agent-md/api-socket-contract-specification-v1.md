...
| MF-17 | Referral                                 | Referral code/share, attribution, progress, and reward-status endpoints to be finalized in OpenAPI                         | Socket not required                                            | Reward is credited only after the referred user completes 5 paid tasks; do not invent paths.     |
