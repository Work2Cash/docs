...
generated_from: content/flows/admin/main/AF-13-task-media-moderation.md
do_not_edit: true
---

> Generated agent document. Edit `content/flows/admin/main/AF-13-task-media-moderation.md` and rerun `node scripts/generate-flow-docs.js`.
