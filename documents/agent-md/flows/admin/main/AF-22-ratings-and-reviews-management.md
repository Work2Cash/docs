...
generated_from: content/flows/admin/main/AF-22-ratings-and-reviews-management.md
do_not_edit: true
---

> Generated agent document. Edit `content/flows/admin/main/AF-22-ratings-and-reviews-management.md` and rerun `node scripts/generate-flow-docs.js`.
