...
generated_from: content/flows/admin/main/AF-24-receipt-and-transaction-review.md
do_not_edit: true
---

> Generated agent document. Edit `content/flows/admin/main/AF-24-receipt-and-transaction-review.md` and rerun `node scripts/generate-flow-docs.js`.
