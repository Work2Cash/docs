...
related: AF-02, AF-24, AF-03, AF-16, AF-17, AF-21, AF-23
generated_from: content/flows/admin/subflows/ASF-02-rbac-permission-gate.md
do_not_edit: true
---

> Generated agent document. Edit `content/flows/admin/subflows/ASF-02-rbac-permission-gate.md` and rerun `node scripts/generate-flow-docs.js`.
