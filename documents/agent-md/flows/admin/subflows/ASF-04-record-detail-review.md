...
generated_from: content/flows/admin/subflows/ASF-04-record-detail-review.md
do_not_edit: true
---

> Generated agent document. Edit `content/flows/admin/subflows/ASF-04-record-detail-review.md` and rerun `node scripts/generate-flow-docs.js`.
