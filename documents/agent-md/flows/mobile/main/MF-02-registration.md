...
related: SF-01, SF-02, SF-10, MF-04, MF-05
generated_from: content/flows/mobile/main/MF-02-registration.md
do_not_edit: true
---

> Generated agent document. Edit `content/flows/mobile/main/MF-02-registration.md` and rerun `node scripts/generate-flow-docs.js`.
