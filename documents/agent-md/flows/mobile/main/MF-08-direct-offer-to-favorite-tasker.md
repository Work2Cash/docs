...
generated_from: content/flows/mobile/main/MF-08-direct-offer-to-favorite-tasker.md
do_not_edit: true
---

> Generated agent document. Edit `content/flows/mobile/main/MF-08-direct-offer-to-favorite-tasker.md` and rerun `node scripts/generate-flow-docs.js`.
