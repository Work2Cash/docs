...
related: SF-05, SF-07, SF-08, SF-10, MF-14, MF-12, MF-16
generated_from: content/flows/mobile/main/MF-10-active-task-execution.md
do_not_edit: true
---

> Generated agent document. Edit `content/flows/mobile/main/MF-10-active-task-execution.md` and rerun `node scripts/generate-flow-docs.js`.
