...
related: MF-08, MF-06
generated_from: content/flows/mobile/main/MF-15-favorites.md
do_not_edit: true
---

> Generated agent document. Edit `content/flows/mobile/main/MF-15-favorites.md` and rerun `node scripts/generate-flow-docs.js`.
