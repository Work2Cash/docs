...
generated_from: content/flows/mobile/main/MF-22-ratings-and-reviews.md
do_not_edit: true
---

> Generated agent document. Edit `content/flows/mobile/main/MF-22-ratings-and-reviews.md` and rerun `node scripts/generate-flow-docs.js`.
