...
related: MF-02, MF-03, MF-18, MF-19
generated_from: content/flows/mobile/subflows/SF-01-otp-verification.md
do_not_edit: true
---

> Generated agent document. Edit `content/flows/mobile/subflows/SF-01-otp-verification.md` and rerun `node scripts/generate-flow-docs.js`.
