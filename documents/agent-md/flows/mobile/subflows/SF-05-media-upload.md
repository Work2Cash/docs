...
related: MF-06, MF-10, MF-14, MF-16, MF-23, MF-24
generated_from: content/flows/mobile/subflows/SF-05-media-upload.md
do_not_edit: true
---

> Generated agent document. Edit `content/flows/mobile/subflows/SF-05-media-upload.md` and rerun `node scripts/generate-flow-docs.js`.
