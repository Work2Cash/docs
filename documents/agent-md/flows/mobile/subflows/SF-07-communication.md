...
related: MF-10
generated_from: content/flows/mobile/subflows/SF-07-communication.md
do_not_edit: true
---

> Generated agent document. Edit `content/flows/mobile/subflows/SF-07-communication.md` and rerun `node scripts/generate-flow-docs.js`.
