...
related: MF-05, MF-09, MF-21
generated_from: content/flows/mobile/subflows/SF-09-permission-recovery.md
do_not_edit: true
---

> Generated agent document. Edit `content/flows/mobile/subflows/SF-09-permission-recovery.md` and rerun `node scripts/generate-flow-docs.js`.
