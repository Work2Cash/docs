...
related: MF-03
generated_from: content/flows/mobile/subflows/SF-11-password-recovery.md
do_not_edit: true
---

> Generated agent document. Edit `content/flows/mobile/subflows/SF-11-password-recovery.md` and rerun `node scripts/generate-flow-docs.js`.
