...
related: MF-13
generated_from: content/flows/mobile/subflows/SF-12-payout-account-setup.md
do_not_edit: true
---

> Generated agent document. Edit `content/flows/mobile/subflows/SF-12-payout-account-setup.md` and rerun `node scripts/generate-flow-docs.js`.
