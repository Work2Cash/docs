---
id: SF-13
title: Google / Apple Social Authentication
...
related: MF-03
generated_from: content/flows/mobile/subflows/SF-13-google-apple-social-authentication.md
do_not_edit: true
---

> Generated agent document. Edit `content/flows/mobile/subflows/SF-13-google-apple-social-authentication.md` and rerun `node scripts/generate-flow-docs.js`.
