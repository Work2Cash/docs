...
| DATA-KYC | [Tasker Activation and KYC Data Domain](data/kyc-domain.md) | data-domain | approved-reference |
| AF-04 | [Tasker and KYC Review](flows/admin/AF-04-kyc-review.md) | main-flow | approved-reference |
| MF-06 | [Task Owner Create and Fund Task](flows/mobile/MF-06-create-and-fund-task.md) | main-flow | approved-reference |
| QA-AF-04 | [AF-04 KYC Review Reference Suite](qa/AF-04-kyc-review-suite.md) | qa-suite | approved-reference |
