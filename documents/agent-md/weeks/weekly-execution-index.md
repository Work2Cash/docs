# Work2Cash Weekly Execution Packs
...
- [Week 2 - Tasker, Task Creation and Payment](./week-02-tasker-task-creation-payment.md)
- [Week 3 - Discovery, Matching and Execution Start](./week-03-discovery-matching-execution-start.md)
- [Week 4 - Completion, Finance and Support](./week-04-completion-finance-support.md)
- [Week 5 - Integration, Recovery and Full Flow QA](./week-05-integration-recovery-full-flow-qa.md)
- [Week 6 - Hardening, Security and Performance](./week-06-hardening-security-performance.md)
- [Week 7 - Release Candidate and Operations Dry Run](./week-07-release-candidate-operations-dry-run.md)
- [Week 8 - Stabilization and Freeze](./week-08-stabilization-freeze.md)
