...
This Markdown brief is the execution companion for `Mobile Build Plan v1`.
...
2. `Mobile Flow Catalogue v1`
3. `API & Socket Contract Specification v1`
4. `Data Model & Prisma Schema Planning v1`
5. `Provider Integration & Cost Control v1`
6. `Mobile Build Plan v1`
