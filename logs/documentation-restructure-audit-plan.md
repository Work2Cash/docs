...
| 17 July 2026 | Six mobile flow-to-contract ID/title collisions reconciled without changing approved behavior | Codex, under Product and Technical Lead direction | Five mappings resolved from existing contracts; MF-17 referral paths remain an explicit Phase 4 gap |
